                ...
                if msg.text != None:
                    if msg.toType == 2:
                        ...
                        if may in str(msg.contentMetadata) and 'MENTION' in str(msg.contentMetadata):
                            pilih = ['มีธุระเร่งด่วนทักส่วนตัวนะ เดี๋ยวว่างจะมาตอบแท็ก','ธุระด่วนทักแชทเลยครับผม','แท็กกันเข้าไป เดี๋ยวว่างจะมาตอบแท็ก เพราะนี่คือข้อความอัตโนมัติ','แท็กมาทำไม ไม่อยู่ ไปข้างนอก เดี๋ยวมาตอบ','แท็กอะไรกันนักกันหนาว่ะ']
                    ...
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                pref=['กำลังอ่าน..','กำลังอ่าน..','กำลังอ่าน..','กำลังอ่าน..','กำลังอ่าน..','กำลังอ่าน..','กำลังอ่าน..']
